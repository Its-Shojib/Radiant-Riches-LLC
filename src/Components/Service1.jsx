        ...
        <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 justify-center gap-10">
                <div className="relative col-span-1">
                    <p className="absolute text-gray-600 top-5">1</p>
                ...
                <div className="text-[12px] text-gray-600 space-y-3 col-span-2">
                    ...
                    <p className="pl-3">[What You Get]: Receive the WixPro website builder suite, access to premium design templates, an extensive library of widgets and apps, and detailed step-by-step guides.</p>
