        ...
        <div className='my-10'>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10'>
                ...
                <div className="card bg-base-100">
                    ...
                    <p className='text-gray-600 text-sm max-w-60'>Computer  Modern clasic with wix support</p>
                    <p className='my-3'>
                    ...
                    <div className="card-actions">
                        <button className="w-full py-2 bg-blue-500 text-white rounded-md">View Deal</button>
                    </div>
                </div>
                {/* Card-2 */}
                <div className="card bg-base-100">
